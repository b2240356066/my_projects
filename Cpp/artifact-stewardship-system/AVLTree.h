...
public:
    ...
    //added helper function for match parity
    void printArtifactsWithRarity(int minRarity) const;
...
private:
    ...
    //added helper function for match parity
    void printArtifactsWithRarity(ArtifactNode *node, int minRarity) const;
};
